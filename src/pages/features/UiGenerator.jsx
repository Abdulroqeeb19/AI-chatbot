  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col xl:flex-row gap-6 h-[calc(100vh-8rem)]">
        ...
        <div className="xl:w-[420px] shrink-0 flex flex-col">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {TEMPLATE_PROMPTS.map((t) => (
                    <button
                      key={t}
                      onClick={() => setPrompt(t)}
                      className="px-2.5 py-1 text-micro rounded-md bg-neutral-800/50 border border-neutral-700/30 text-neutral-400 hover:text-neutral-200 hover:border-primary-500/30 transition-all"
                    >
          ...
          <Card className="flex-1 flex flex-col">
            ...
            <div className="flex-1 rounded-xl border border-neutral-800/50 bg-neutral-900/30 overflow-hidden">
              {viewMode === 'preview' ? (
                <div className={`h-full mx-auto transition-all duration-300 ${
                  ...
                  <div className="h-full flex items-center justify-center">
                    <div className="text-center space-y-4">
                      <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-primary-500/20 to-secondary-500/20 border border-primary-500/20 flex items-center justify-center">
                ...
                <div className="p-6 font-mono text-body-sm text-neutral-400 h-full overflow-auto">
